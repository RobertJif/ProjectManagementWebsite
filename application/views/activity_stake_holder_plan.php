          ...
          <div class="x_panel">
            <div class="x_title">
              ...
              <button type="submit" class="btn btn-danger">Back</button>
                ...
                <li>        <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Add Stake Holder</button>
                <!-- Small modal -->
                ...
                <div class="modal fade" id="myModal<?php echo $id; ?>" role="dialog">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content" >
                      ...
                      <form method="post" action="<?php echo base_url().'index.php/projectcharter/edit_activity_stake_holder'?>">
                      <input type="hidden" name="id_proj" id="id_proj" value="<?php echo $id_proj?>">
