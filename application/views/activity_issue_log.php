          ...
          <div class="x_panel">
            <div class="x_title">
              ...
              <button type="submit" class="btn btn-danger">Back</button>
                ...
                <li>        <button style="display: none" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Add Communication</button>
                <!-- Small modal -->
      ...
      foreach($activity_issue_log_data->result_array() as $is => $i):
        ...
        <tr>
          ...
          <td>
            ...
            <?php if(UR_exists(base_url()."files/".$file)){?>
            <a href="/dicka/files/<?php echo $file ?>"><?php echo $file ?></td>
            <?php }
            ?>
          <td>
