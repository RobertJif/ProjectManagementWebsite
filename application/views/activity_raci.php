    ...
    <?php
      foreach($planning_scope_resource_data->result_array() as $is => $i):
        ...
        <tr>
          ...
          <td><?php
          if ($remaining>0) {
            echo "<p style='color:red'>".$remaining." (ACTION NEEDED)</p>";
          }
          else{
            echo "<p style='color:lightgreen'>".$remaining."</p>";
             }
           ?></td>
         
          <td>
                          <a href="#" onclick="viewProject(<?php echo $id_project; ?>,<?php echo $id; ?>)"><i class="fa fa-search"> View Scores</i></a>&nbsp&nbsp
...
<script type="text/javascript">
     function viewProject(id_project,id_resource){
        window.location ="<?php echo site_url('projectcharter/view_raci_scores/'); ?>"+id_project+"/"+id_resource;
    }
