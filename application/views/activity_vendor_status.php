    ...
    <?php
      foreach($activity_vendor_data->result_array() as $is => $i):
        ...
        <tr>
          ...
          <td><a href="/dicka/files/<?php echo $document ?>"><?php echo $document ?></td>
          <td><?php echo $status?></td>
          <td>
            <a href="#" onclick="hapusProject(<?php echo $id; ?>,<?php echo $id_project; ?>)"><i class="fa fa-trash"> Close</i></a>
...
<script type="text/javascript">
  $(function () {
    ...
    var r = confirm("Are you sure want to close this vendor ?");
    if (r == true) {
        //alert("<?php echo site_url('projectcharter/hapus_activity_vendor?id='); ?>"+id);
        window.location ="<?php echo site_url('projectcharter/close_activity_vendor/'); ?>"+id+"/"+id_project;
      } else {
      }
    }
