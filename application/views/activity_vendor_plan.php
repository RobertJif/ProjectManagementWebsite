          ...
          <div class="x_panel">
            <div class="x_title">
              ...
              <button type="submit" class="btn btn-danger">Back</button>
                ...
                <li>        <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Add Vendor</button>
                <!-- Small modal -->
...
<script type="text/javascript">
  $(function () {
    ...
    var r = confirm("Are you sure want to CLOSE this project ?");
    if (r == true) {
