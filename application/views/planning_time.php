               ...
               <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-edit"></i> Project Management <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="<?php echo site_url('collectcontrolling/collect_requirement')?>">Collect Requirement</a></li>
                     <li><a href="<?php echo site_url('collectcontrolling/collect_requirement')?>">Define Scope</a></li>
                    <li><a href="<?php echo site_url('definescope/define_scope')?>">Planning Time</a></li>
