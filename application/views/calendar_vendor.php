...
<html lang="en">
 ...
 $('#calendar').fullCalendar({
     eventSources: [
         {
             events: function(start, end, timezone, callback) {
                 $.ajax({
                 url: '<?php echo site_url() ?>/ProjectCharter/getEvents_vendor/'+bla,
                 dataType: 'json',
    ...
    element.find('.fc-title').append('<i class="fa fa-search"  style="color:black"> '+event.cost+'</i><br>');
    element.find('.fc-title').append('<i class="fa fa-search"  style="color:black"> '+event.quality+'</i><br>');
